...
def tuning_parameters(X_train, y_train):
    ...
    n_estimators_values = [10,25,50,100,150,300]
    max_depth_values = [5,50,150,200]
    min_samples_leaf_values = [50,100,150]

    parameters = {'n_estimators': n_estimators_values, 'max_depth':max_depth_values,'min_samples_leaf':min_samples_leaf_values}
...
def train_RF(parameters,X_train,y_train,X_test,y_test):
    ...
    model = RandomForestRegressor(n_estimators=parameters['n_estimators'], max_depth=parameters['max_depth'],min_samples_leaf=parameters['min_samples_leaf'])
